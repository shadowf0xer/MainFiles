...
// End Cross Module References
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UVoxelGraphOutputsConfigFactory_Statics::Class_MetaDataParams[] = {
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_UVoxelGraphOutputsConfigFactory_Statics::ClassParams = {
	...
	UClass* Z_Construct_UClass_UVoxelGraphOutputsConfigFactory()
	{
		...
		if (!OuterClass)
		{
			UE4CodeGen_Private::ConstructUClass(OuterClass, Z_Construct_UClass_UVoxelGraphOutputsConfigFactory_Statics::ClassParams);
		}
		return OuterClass;
	}
	IMPLEMENT_CLASS(UVoxelGraphOutputsConfigFactory, 2958723632);
	template<> VOXELEDITOR_API UClass* StaticClass<UVoxelGraphOutputsConfigFactory>()
	{
		return UVoxelGraphOutputsConfigFactory::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UVoxelGraphOutputsConfigFactory(Z_Construct_UClass_UVoxelGraphOutputsConfigFactory, &UVoxelGraphOutputsConfigFactory::StaticClass, TEXT("/Script/VoxelEditor"), TEXT("UVoxelGraphOutputsConfigFactory"), false, nullptr, nullptr, nullptr);
