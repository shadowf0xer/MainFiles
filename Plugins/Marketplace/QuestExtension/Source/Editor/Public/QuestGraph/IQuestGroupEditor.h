...
class IQuestGroupEditor : public FAssetEditorToolkit
{
public:
	/** Returns the Quest asset inspected by the editor */
	virtual UQuestGroup* GetQuest() const = 0;
	...
	virtual void InitializeDebuggerState(class FQuestGroupDebugger* ParentDebugger) const = 0;
};
