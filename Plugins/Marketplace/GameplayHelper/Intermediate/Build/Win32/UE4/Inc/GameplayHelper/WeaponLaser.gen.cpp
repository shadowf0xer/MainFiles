...
// End Cross Module References
	DEFINE_FUNCTION(UWeaponLaser::execInitializeLaserComponent)
	{
	...
	DEFINE_FUNCTION(UWeaponLaser::execGetState)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UWeaponLaser::execSetState)
	{
	...
	DEFINE_FUNCTION(UWeaponLaser::execToggleLaser)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->ToggleLaser();
	...
	IMPLEMENT_CLASS(UWeaponLaser, 3530488871);
