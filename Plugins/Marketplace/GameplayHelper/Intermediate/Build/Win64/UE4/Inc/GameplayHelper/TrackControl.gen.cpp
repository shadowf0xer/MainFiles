...
// End Cross Module References
	DEFINE_FUNCTION(UTrackControl::execInitialize)
	{
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UTrackControl_Initialize_Statics::NewProp_inComponents = { "inComponents", nullptr, (EPropertyFlags)0x0010008000000080, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(TrackControl_eventInitialize_Parms, inComponents), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UFunction_UTrackControl_Initialize_Statics::NewProp_inComponents_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UTrackControl_Initialize_Statics::NewProp_inComponents_MetaData)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UTrackControl_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UTrackControl_Initialize, "Initialize" }, // 3594428813
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UTrackControl, 1857698823);
