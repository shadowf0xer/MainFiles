...
// End Cross Module References
	DEFINE_FUNCTION(ULookAround::execStopLookAround)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(ULookAround::execStartLookAround)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(ULookAround::execGetLookingAround)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	IMPLEMENT_CLASS(ULookAround, 1352240493);
