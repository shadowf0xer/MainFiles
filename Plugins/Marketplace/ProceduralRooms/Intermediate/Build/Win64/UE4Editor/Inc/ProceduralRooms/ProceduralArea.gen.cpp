...
#include "ProceduralRooms/Public/ProceduralArea.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	PROCEDURALROOMS_API UEnum* Z_Construct_UEnum_ProceduralRooms_ERenderType();
	UPackage* Z_Construct_UPackage__Script_ProceduralRooms();
	PROCEDURALROOMS_API UEnum* Z_Construct_UEnum_ProceduralRooms_ECubeParts();
	PROCEDURALROOMS_API UScriptStruct* Z_Construct_UScriptStruct_FCubesDoor();
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FVector2D();
	PROCEDURALROOMS_API UScriptStruct* Z_Construct_UScriptStruct_FCubesOffcet();
	PROCEDURALROOMS_API UClass* Z_Construct_UClass_AProceduralArea_NoRegister();
	PROCEDURALROOMS_API UClass* Z_Construct_UClass_AProceduralArea();
...
// End Cross Module References
	static UEnum* ERenderType_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_ProceduralRooms_ERenderType, Z_Construct_UPackage__Script_ProceduralRooms(), TEXT("ERenderType"));
		}
		return Singleton;
	}
	template<> PROCEDURALROOMS_API UEnum* StaticEnum<ERenderType>()
	{
		return ERenderType_StaticEnum();
	}
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ERenderType(ERenderType_StaticEnum, TEXT("/Script/ProceduralRooms"), TEXT("ERenderType"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_ProceduralRooms_ERenderType_Hash() { return 2606530741U; }
	UEnum* Z_Construct_UEnum_ProceduralRooms_ERenderType()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_ProceduralRooms();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("ERenderType"), 0, Get_Z_Construct_UEnum_ProceduralRooms_ERenderType_Hash(), false);
#else
		...
		if (!ReturnEnum)
		{
			...
			static const UE4CodeGen_Private::FEnumParams EnumParams = {
				(UObject*(*)())Z_Construct_UPackage__Script_ProceduralRooms,
				nullptr,
				"ERenderType",
				"ERenderType",
				Enumerators,
	...
	static UEnum* ECubeParts_StaticEnum()
	{
		...
		if (!Singleton)
		{
			Singleton = GetStaticEnum(Z_Construct_UEnum_ProceduralRooms_ECubeParts, Z_Construct_UPackage__Script_ProceduralRooms(), TEXT("ECubeParts"));
		}
		return Singleton;
	}
	template<> PROCEDURALROOMS_API UEnum* StaticEnum<ECubeParts>()
	{
		return ECubeParts_StaticEnum();
	}
	static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_ECubeParts(ECubeParts_StaticEnum, TEXT("/Script/ProceduralRooms"), TEXT("ECubeParts"), false, nullptr, nullptr);
	uint32 Get_Z_Construct_UEnum_ProceduralRooms_ECubeParts_Hash() { return 3873525620U; }
	UEnum* Z_Construct_UEnum_ProceduralRooms_ECubeParts()
	{
#if WITH_HOT_RELOAD
		UPackage* Outer = Z_Construct_UPackage__Script_ProceduralRooms();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("ECubeParts"), 0, Get_Z_Construct_UEnum_ProceduralRooms_ECubeParts_Hash(), false);
#else
		static UEnum* ReturnEnum = nullptr;
#endif // WITH_HOT_RELOAD
		if (!ReturnEnum)
...
class UScriptStruct* FCubesDoor::StaticStruct()
{
	...
	if (!Singleton)
	{
		extern PROCEDURALROOMS_API uint32 Get_Z_Construct_UScriptStruct_FCubesDoor_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FCubesDoor, Z_Construct_UPackage__Script_ProceduralRooms(), TEXT("CubesDoor"), sizeof(FCubesDoor), Get_Z_Construct_UScriptStruct_FCubesDoor_Hash());
	}
	return Singleton;
}
template<> PROCEDURALROOMS_API UScriptStruct* StaticStruct<FCubesDoor>()
{
	return FCubesDoor::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FCubesDoor(FCubesDoor::StaticStruct, TEXT("/Script/ProceduralRooms"), TEXT("CubesDoor"), false, nullptr, nullptr);
static struct FScriptStruct_ProceduralRooms_StaticRegisterNativesFCubesDoor
{
	FScriptStruct_ProceduralRooms_StaticRegisterNativesFCubesDoor()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("CubesDoor")),new UScriptStruct::TCppStructOps<FCubesDoor>);
	}
} ScriptStruct_ProceduralRooms_StaticRegisterNativesFCubesDoor;
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FCubesDoor_Statics::NewProp_part = { "part", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCubesDoor, part), Z_Construct_UEnum_ProceduralRooms_ECubeParts, METADATA_PARAMS(Z_Construct_UScriptStruct_FCubesDoor_Statics::NewProp_part_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCubesDoor_Statics::NewProp_part_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCubesDoor_Statics::ReturnStructParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCubesDoor_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FCubesDoor_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCubesDoor_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FCubesDoor_Hash() { return 1310903264U; }
class UScriptStruct* FCubesOffcet::StaticStruct()
{
	static class UScriptStruct* Singleton = NULL;
	if (!Singleton)
	{
		extern PROCEDURALROOMS_API uint32 Get_Z_Construct_UScriptStruct_FCubesOffcet_Hash();
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FCubesOffcet, Z_Construct_UPackage__Script_ProceduralRooms(), TEXT("CubesOffcet"), sizeof(FCubesOffcet), Get_Z_Construct_UScriptStruct_FCubesOffcet_Hash());
	}
	return Singleton;
}
template<> PROCEDURALROOMS_API UScriptStruct* StaticStruct<FCubesOffcet>()
{
	return FCubesOffcet::StaticStruct();
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FCubesOffcet(FCubesOffcet::StaticStruct, TEXT("/Script/ProceduralRooms"), TEXT("CubesOffcet"), false, nullptr, nullptr);
static struct FScriptStruct_ProceduralRooms_StaticRegisterNativesFCubesOffcet
{
	FScriptStruct_ProceduralRooms_StaticRegisterNativesFCubesOffcet()
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("CubesOffcet")),new UScriptStruct::TCppStructOps<FCubesOffcet>);
	}
} ScriptStruct_ProceduralRooms_StaticRegisterNativesFCubesOffcet;
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCubesOffcet_Statics::NewProp_maxOffcet = { "maxOffcet", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCubesOffcet, maxOffcet), METADATA_PARAMS(Z_Construct_UScriptStruct_FCubesOffcet_Statics::NewProp_maxOffcet_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCubesOffcet_Statics::NewProp_maxOffcet_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FCubesOffcet_Statics::NewProp_minOffcet = { "minOffcet", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FCubesOffcet, minOffcet), METADATA_PARAMS(Z_Construct_UScriptStruct_FCubesOffcet_Statics::NewProp_minOffcet_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCubesOffcet_Statics::NewProp_minOffcet_MetaData)) };
	...
	const UE4CodeGen_Private::FStructParams Z_Construct_UScriptStruct_FCubesOffcet_Statics::ReturnStructParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCubesOffcet_Statics::PropPointers),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EStructFlags(0x00000001),
		METADATA_PARAMS(Z_Construct_UScriptStruct_FCubesOffcet_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FCubesOffcet_Statics::Struct_MetaDataParams))
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FCubesOffcet_Hash() { return 3853200194U; }
	DEFINE_FUNCTION(AProceduralArea::execGenerateArea)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->GenerateArea();
	...
	DEFINE_FUNCTION(AProceduralArea::execSetMeshMaterial)
	{
	...
	DEFINE_FUNCTION(AProceduralArea::execGenerateTexture)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(AProceduralArea::execGenerateCubes)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
...
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AProceduralArea_SetMeshMaterial_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AProceduralArea, nullptr, "SetMeshMaterial", nullptr, nullptr, sizeof(ProceduralArea_eventSetMeshMaterial_Parms), Z_Construct_UFunction_AProceduralArea_SetMeshMaterial_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AProceduralArea_SetMeshMaterial_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AProceduralArea_SetMeshMaterial_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AProceduralArea_SetMeshMaterial_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AProceduralArea_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AProceduralArea_GenerateArea, "GenerateArea" }, // 989937791
		{ &Z_Construct_UFunction_AProceduralArea_GenerateCubes, "GenerateCubes" }, // 1470993235
		{ &Z_Construct_UFunction_AProceduralArea_GenerateTexture, "GenerateTexture" }, // 3125345664
		{ &Z_Construct_UFunction_AProceduralArea_SetMeshMaterial, "SetMeshMaterial" }, // 1440978291
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AProceduralArea_Statics::NewProp_cornersMaterial = { "cornersMaterial", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProceduralArea, cornersMaterial), Z_Construct_UClass_UMaterial_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AProceduralArea_Statics::NewProp_cornersMaterial_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProceduralArea_Statics::NewProp_cornersMaterial_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AProceduralArea_Statics::NewProp_cornersMesh = { "cornersMesh", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProceduralArea, cornersMesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AProceduralArea_Statics::NewProp_cornersMesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProceduralArea_Statics::NewProp_cornersMesh_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AProceduralArea_Statics::NewProp_mesh = { "mesh", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProceduralArea, mesh), Z_Construct_UClass_UStaticMesh_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AProceduralArea_Statics::NewProp_mesh_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProceduralArea_Statics::NewProp_mesh_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FStructPropertyParams Z_Construct_UClass_AProceduralArea_Statics::NewProp_offcet = { "offcet", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProceduralArea, offcet), Z_Construct_UScriptStruct_FCubesOffcet, METADATA_PARAMS(Z_Construct_UClass_AProceduralArea_Statics::NewProp_offcet_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProceduralArea_Statics::NewProp_offcet_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AProceduralArea_Statics::NewProp_doorParts = { "doorParts", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProceduralArea, doorParts), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AProceduralArea_Statics::NewProp_doorParts_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProceduralArea_Statics::NewProp_doorParts_MetaData)) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AProceduralArea_Statics::NewProp_removedParts = { "removedParts", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProceduralArea, removedParts), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AProceduralArea_Statics::NewProp_removedParts_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProceduralArea_Statics::NewProp_removedParts_MetaData)) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AProceduralArea_Statics::NewProp_removedParts_Inner = { "removedParts", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UEnum_ProceduralRooms_ECubeParts, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AProceduralArea_Statics::NewProp_roundParts = { "roundParts", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProceduralArea, roundParts), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_AProceduralArea_Statics::NewProp_roundParts_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProceduralArea_Statics::NewProp_roundParts_MetaData)) };
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AProceduralArea_Statics::NewProp_roundParts_Inner = { "roundParts", nullptr, (EPropertyFlags)0x0000000000000000, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UEnum_ProceduralRooms_ECubeParts, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UE4CodeGen_Private::FUnsizedIntPropertyParams Z_Construct_UClass_AProceduralArea_Statics::NewProp_seed = { "seed", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProceduralArea, seed), METADATA_PARAMS(Z_Construct_UClass_AProceduralArea_Statics::NewProp_seed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProceduralArea_Statics::NewProp_seed_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_AProceduralArea_Statics::NewProp_depth = { "depth", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProceduralArea, depth), METADATA_PARAMS(Z_Construct_UClass_AProceduralArea_Statics::NewProp_depth_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProceduralArea_Statics::NewProp_depth_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_AProceduralArea_Statics::NewProp_height = { "height", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProceduralArea, height), METADATA_PARAMS(Z_Construct_UClass_AProceduralArea_Statics::NewProp_height_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProceduralArea_Statics::NewProp_height_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AProceduralArea_Statics::NewProp_texture = { "texture", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProceduralArea, texture), Z_Construct_UClass_UTexture2D_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AProceduralArea_Statics::NewProp_texture_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProceduralArea_Statics::NewProp_texture_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AProceduralArea_Statics::NewProp_Render = { "Render", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AProceduralArea, Render), Z_Construct_UEnum_ProceduralRooms_ERenderType, METADATA_PARAMS(Z_Construct_UClass_AProceduralArea_Statics::NewProp_Render_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AProceduralArea_Statics::NewProp_Render_MetaData)) };
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_AProceduralArea_Statics::ClassParams = {
		...
		UE_ARRAY_COUNT(Z_Construct_UClass_AProceduralArea_Statics::PropPointers),
		0,
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_AProceduralArea_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AProceduralArea_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(AProceduralArea, 410190829);
	template<> PROCEDURALROOMS_API UClass* StaticClass<AProceduralArea>()
	{
		return AProceduralArea::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AProceduralArea(Z_Construct_UClass_AProceduralArea, &AProceduralArea::StaticClass, TEXT("/Script/ProceduralRooms"), TEXT("AProceduralArea"), false, nullptr, nullptr, nullptr);
