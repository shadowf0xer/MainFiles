...
void EmptyLinkFunctionForGeneratedCodeTargetSystem_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_TargetSystem()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_TargetSystem_ComponentOnTargetLockedOnOff__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_TargetSystem_ComponentSetRotation__DelegateSignature,
			};
